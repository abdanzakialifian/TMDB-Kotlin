package com.application.tmdb.castcrew.view

import androidx.core.content.ContextCompat
import androidx.fragment.app.viewModels
import androidx.navigation.fragment.navArgs
import com.application.tmdb.castcrew.viewmodel.DetailCastCrewViewModel
                ...
                is UiState.Success -> {
                    ...
                    binding?.apply {
                        tvBiography.setResizableText(
                            detailCastCrew.biography.orEmpty(),
                            3,
                            true,
                            layoutText
                        )
                        imgPeople.loadImageUrl(detailCastCrew.profilePath.orEmpty())
