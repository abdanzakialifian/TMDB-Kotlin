package com.application.tmdb.data.source.remote

import androidx.paging.Pager
import androidx.paging.PagingConfig
import androidx.paging.PagingData
import androidx.paging.rxjava2.flowable
import com.application.tmdb.data.source.remote.paging.movies.MoviesRxPagingSource
import com.application.tmdb.data.source.remote.paging.other.DiscoverRxPagingSource
import com.application.tmdb.data.source.remote.paging.other.ReviewsRxPagingSource
import com.application.tmdb.data.source.remote.paging.tvshows.TvShowsRxPagingSource
import com.application.tmdb.data.source.remote.response.movies.DetailMoviesResponse
import com.application.tmdb.data.source.remote.response.movies.ListMoviesResponse
import com.application.tmdb.data.source.remote.response.other.DetailCastResponse
import com.application.tmdb.data.source.remote.response.other.ResultsItemDiscoverResponse
import com.application.tmdb.data.source.remote.response.other.ReviewItemResponse
import com.application.tmdb.data.source.remote.response.tvshows.DetailTvShowsResponse
import com.application.tmdb.data.source.remote.response.tvshows.ListTvShowsResponse
