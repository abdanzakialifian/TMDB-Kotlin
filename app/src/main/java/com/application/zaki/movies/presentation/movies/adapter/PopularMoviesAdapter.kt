...
class PopularMoviesAdapter(private val onItemClickCallback: OnItemClickCallback) :
    ListAdapter<ListPopularMovies, PopularMoviesAdapter.PopularMoviesViewHolder>(DIFF_CALLBACK) {
